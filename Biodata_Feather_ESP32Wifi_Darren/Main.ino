...
//  //check battery level, if low then set all to red
//  float batteryLevel = (analogRead(A13)/4095)*2*3.3*1.1;
//
// // if(batteryLevel < batteryMin) { 
//    if(currentMillis - lastBatFlash > lowBatFlashTime) {
//        //set all LED red
//        if(lowBatToggle) fill_solid(leds,NUM_LEDS,CRGB::Red);
//        lastBatFlash = currentMillis;
